...
public class ParseSAXCommand implements Command {
    static final Logger LOGGER = LogManager.getLogger(ParseSAXCommand.class.getName());
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            request.setAttribute(
                    ...
                    parseService.parseSAXReview(request.getPart(JSPParameterName.FILE.getParameter()).getInputStream())
            );
