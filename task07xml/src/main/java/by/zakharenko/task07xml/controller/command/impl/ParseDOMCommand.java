...
public class ParseDOMCommand implements Command {
    static final Logger LOGGER = LogManager.getLogger(ParseDOMCommand.class.getName());
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            request.setAttribute(
                    ...
                    parseService.parseDomReview(request.getPart(JSPParameterName.FILE.getParameter()).getInputStream())
            );
