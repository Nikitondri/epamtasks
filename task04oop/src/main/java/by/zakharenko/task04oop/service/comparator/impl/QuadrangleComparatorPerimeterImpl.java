...
public class QuadrangleComparatorPerimeterImpl implements QuadrangleComparator {
    @Override
    public int compare(Quadrangle quadrangleOne, Quadrangle quadrangleTwo) {
        ...
        return Double.compare(quadrangleRegistrarOne.getPerimeter(), quadrangleRegistrarTwo.getPerimeter());
    }
}
