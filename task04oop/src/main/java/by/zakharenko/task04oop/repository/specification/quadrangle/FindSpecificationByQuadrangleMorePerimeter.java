...
public class FindSpecificationByQuadrangleMorePerimeter extends CompositeSpecification<Quadrangle> {
    private final double perimeter;

    public FindSpecificationByQuadrangleMorePerimeter(double perimeter) {
