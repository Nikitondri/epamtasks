...
public class FindSpecificationByQuadranglePerimeter extends CompositeSpecification<Quadrangle> {
    private final double perimeter;

    public FindSpecificationByQuadranglePerimeter(double perimeter) {
