...
import by.zakharenko.task06composite.controller.command.impl.CollectTextImpl;
...
public class CollectTextImplTest {

    private Command command;

    @BeforeClass
    public void init(){
        command = new CollectTextImpl();
    }
    ...
    public Object[][] executeData(){
        ...
        result.put(true, "\r\n\t  It has survived - not only (five) centuries, but also the leap into 52 electronic typesetting, remaining 3 essentially 9 unchanged.");
        return
                new Object[][]{
                        {list1, result}
                };
