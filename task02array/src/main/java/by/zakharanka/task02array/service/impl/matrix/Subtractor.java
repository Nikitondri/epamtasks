...
public class Subtractor {
    ...
    /**
     * method implements matrix subtraction
     * subtracting sequentially from each element of the reduced each element of the subtracted
     * @param matrix1 minuend
     * @param matrix2 subtrahend
     * @return difference
     */
    public Matrix<Integer> subtract(Matrix<Integer> matrix1, Matrix<Integer> matrix2) throws ServiceException, EntityException {
