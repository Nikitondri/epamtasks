...
/**
 * Class for calling methods for matrix multiplication
 * @see Command
 * @see MatrixService
 */
public class MatrixMultiplicationImpl implements Command  {
    ...
    public HashMap<String, Exception> execute(Data<String> request) throws ControllerException {
        ...
        try{
            ...
            res.put(matrixService.multiplication(matrix1, matrix2), null);
