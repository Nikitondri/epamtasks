...
/**
 * Class for calling methods for sorting array using binary merge sort
 * @see Command
 * @see SortService
 */
public class BinaryMergeSort implements Command {
    ...
    public HashMap<String, Exception> execute(Data<String> request) throws ControllerException {
        ...
        try{
            ...
            res.put(sortService.binaryMergeSort(array), null);
