...
/**
 * Class for calling methods for sorting array using simple insert sort
 * @see Command
 * @see SortService
 */
public class SimpleInsertSort implements Command {
    ...
    public HashMap<String, Exception> execute(Data<String> request) throws ControllerException {
        ...
        try{
            ...
            res.put(sortService.simpleInsertSort(array), null);
