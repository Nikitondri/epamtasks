...
/**
 * Class that runs on a separate thread and calling methods for sorting array using external sort
 * @see Command
 * @see CommandCallable
 * @see SortService
 */
public class ExternalSort extends Command {

    public ExternalSort(Data<String> newRequest) {
        super(newRequest);
    }
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, sortService.externalSort(array));
