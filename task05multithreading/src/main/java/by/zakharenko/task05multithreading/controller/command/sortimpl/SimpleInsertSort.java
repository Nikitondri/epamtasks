...
/**
 * Class that runs on a separate thread and calling methods for sorting array using simple insert sort
 * @see Command
 * @see CommandCallable
 * @see SortService
 */
public class SimpleInsertSort extends Command {

    public SimpleInsertSort(Data<String> newRequest) {
        super(newRequest);
    }

    /**
     * Method for calling methods for sorting array using simple insert sort and exception handling
     * @see Command
     * @see Data
     * @see SortService
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, sortService.simpleInsertSort(array));
