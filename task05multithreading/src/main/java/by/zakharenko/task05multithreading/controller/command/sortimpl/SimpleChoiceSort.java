...
/**
 * Class that runs on a separate thread and calling methods for sorting array using simple choice sort
 * @see Command
 * @see CommandCallable
 * @see SortService
 */
public class SimpleChoiceSort extends Command {

    public SimpleChoiceSort(Data<String> newRequest) {
        super(newRequest);
    }
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, sortService.simpleChoiceSort(array));
