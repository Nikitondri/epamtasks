...
/**
 * Class that runs on a separate thread and calling methods for matrix multiplication by number
 * @see Command
 * @see CommandCallable
 * @see MatrixService
 */
public class MatrixMultiplicationByNumberImpl extends Command {

    public MatrixMultiplicationByNumberImpl(Data<String> newRequest) {
        super(newRequest);
    }
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, matrixService.multiplicationByNumber(matrix1, matrix2.getElement(0, 0)));
