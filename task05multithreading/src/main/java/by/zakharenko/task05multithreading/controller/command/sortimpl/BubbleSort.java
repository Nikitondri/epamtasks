...
/**
 * Class that runs on a separate thread calling methods for sorting array using bubble sort
 * @see CommandCallable
 * @see Command
 * @see SortService
 */
public class BubbleSort extends Command {

    public BubbleSort(Data<String> newRequest) {
        super(newRequest);
    }

    /**
     * Method for calling methods for sorting array using bubble sort and exception handling
     * @see Command
     * @see Data
     * @see SortService
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, sortService.bubbleSort(array));
