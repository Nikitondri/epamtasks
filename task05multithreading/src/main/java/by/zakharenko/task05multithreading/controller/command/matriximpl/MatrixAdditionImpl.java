...
/**
 * Class that runs on a separate thread and calling methods for matrix additional
 * @see CommandCallable
 * @see Command
 * @see MatrixService
 */
public class MatrixAdditionImpl extends Command {

    public MatrixAdditionImpl(Data<String> newRequest) {
        super(newRequest);
    }

    /**
     * Method for calling methods for matrix additional and exception handling
     * @see Command
     * @see Data
     * @see MatrixService
     * @return {@code HashMap} object including result result of matrix additional or exception
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, matrixService.addition(matrix1, matrix2));
