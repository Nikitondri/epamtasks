...
/**
 * Class that runs on a separate thread and calling methods for matrix subtraction
 * @see Command
 * @see CommandCallable
 * @see MatrixService
 */
public class MatrixSubtraction extends Command {

    public MatrixSubtraction(Data<String> newRequest) {
        super(newRequest);
    }
    ...
    public HashMap<Boolean, String> call() throws ControllerException {
        ...
        try{
            ...
            res.put(true, matrixService.subtraction(matrix1, matrix2));
